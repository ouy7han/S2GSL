...
def get_parameter():
    ...
    parser.add_argument('--data_dir', type=str, default='./data/V2/Laptops')
    parser.add_argument('--vocab_dir', type=str, default='./data/V2/Laptops')
    parser.add_argument('--data_name', type=str, default='laptop')
    ...
    parser.add_argument("--alpha", default=0.1, type=float, help="The balance of span loss.")
    parser.add_argument("--beta", default=0.35, type=float, help="The balance of root loss.")
