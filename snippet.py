...
def get_parameter():
    ...
    parser.add_argument('--data_dir', type=str, default='./data/V2/Restaurants')
    parser.add_argument('--vocab_dir', type=str, default='./data/V2/Restaurants')
    parser.add_argument('--data_name', type=str, default='restaurant')
    ...
    parser.add_argument("--gamma", default=0.1, type=float, help="The balance of mtt loss.")
    parser.add_argument("--alpha", default=0.1, type=float, help="The balance of ortho loss.")
    parser.add_argument("--beta", default=0.1, type=float, help="The balance of differential loss.")
